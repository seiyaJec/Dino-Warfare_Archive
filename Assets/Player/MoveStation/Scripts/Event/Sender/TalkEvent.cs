...
[System.Serializable]
public class TalkEvent : MoveStationEventSender
{
    ...
    {
        public PlayerTalkManager.TalkDataWithCheck[] _talkDataWithCheck;
        ...
        {
            player._talkManager.AddTalkDataWithCheck(_talkDataWithCheck);
        }
