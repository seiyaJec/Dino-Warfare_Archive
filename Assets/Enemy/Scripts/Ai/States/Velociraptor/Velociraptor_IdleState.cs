...
public class Velociraptor_IdleState : AiState
{
    ...
    {
        this.patrol = (agent as Velociraptor_Normal_Aiagent).patrol;
    }
    ...
    public void Update(AiAgent agent)
    {
        ...
        else if (timer > timeBetPatorl && agent.targetEntity == null && patrol)
        {
